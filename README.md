...
At the moment, this bad boy containts a few network communication metrics and models at its `core` and a game-theoretical network generation framework at `generative`. I'll just add more stuff as I go.
